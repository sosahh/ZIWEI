	...
	<div class="layui-layout layui-layout-admin">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							...
							<cite><shiro:authenticated><shiro:principal/></shiro:authenticated></cite>
						</a>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<p>你好！<span class="userName"><shiro:authenticated><shiro:principal/></shiro:authenticated></span>, 欢迎登录</p>
			</div>
		...
		<div class="layui-footer footer">
			<p>copyright @2018 苏州聚源创世信息科技有限公司</p>
		</div>
